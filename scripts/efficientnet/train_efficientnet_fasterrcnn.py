...
Usa EfficientNet-B0 como backbone en Faster R-CNN.
"""
...
def get_model_efficientnet_fasterrcnn(num_classes: int, pretrained_backbone: bool = True):
    """
    Crea un modelo Faster R-CNN con backbone EfficientNet-B0.
    ...
    # EfficientNet tiene: features (conv stem + blocks) y classifier
    # Usamos solo las features (hasta antes del pooling y classifier)
    backbone = efficientnet.features
    
    # EfficientNet-B0 último bloque tiene 1280 canales
...
def main(args):
    ...
    print("Arquitectura: EfficientNet-B0 + Faster R-CNN")
    print("=" * 80)
    ...
    experiment_name = f"efficientnet_b0_fasterrcnn_{timestamp}"
    ...
    # Optimizer - EfficientNet funciona mejor con Adam/AdamW
    ...
    # Learning rate scheduler - CosineAnnealing funciona bien con EfficientNet
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description='Entrenar Faster R-CNN con EfficientNet-B0 para detección de defectos'
    )
    ...
    parser.add_argument('--lr', type=float, default=0.0005, help='Learning rate (menor que ResNet)')
